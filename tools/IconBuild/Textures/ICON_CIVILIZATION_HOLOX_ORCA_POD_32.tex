...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/UI/Icons/CivSymbols/ICON_CIVILIZATION_HOLOX_ORCA_POD_32.psd"/>
	<m_SourceObjectName text="loose_layers_only"/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>4183974434</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="ICON_CIVILIZATION_HOLOX_ORCA_POD_32.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="ICON_CIVILIZATION_HOLOX_ORCA_POD_32"/>
	<m_Description text=""/>
	<m_Tags>
