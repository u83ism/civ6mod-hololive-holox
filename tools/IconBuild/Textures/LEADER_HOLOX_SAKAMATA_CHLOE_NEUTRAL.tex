...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/UI/Icons/CivLeaders/LEADER_HOLOX_SAKAMATA_CHLOE_NEUTRAL.psd"/>
	<m_SourceObjectName text="loose_layers_only"/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>218056832</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_HOLOX_SAKAMATA_CHLOE_NEUTRAL.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_HOLOX_SAKAMATA_CHLOE_NEUTRAL"/>
	<m_Description text=""/>
	<m_Tags>
